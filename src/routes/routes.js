...
export default [
    {path: '/', component: getViewComponent('/common/index'),
        children:[
	        ...
	        {path: '/order/detail', component: getViewComponent('/order/detail'),meta: {title: '订单详情-保捷安快递后台管理'}},//
	        {path: '/system/password', component: getViewComponent('/system/password'),meta: {title: '修改-保捷安快递后台管理'}},//
